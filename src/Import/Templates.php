...
class Templates
{
    ...
    public static function universalKeyMapping()
    {
        ...
        return [
            // v1
            // 'dealer_id' => ['DealerID', 'Dealer_ID', 'DEALERID', 'Dealerid', 'Dealer Id', 'Dealer ID'],
            // 'vin' => ['VIN', 'VIN_No', 'VIN_No', 'Vin', 'VIN No'],
            // 'stock_number' => ['StockNumber', 'Stock_No', 'Stock', 'Stock_No', 'Stockno'],
            // 'year' => ['Year'],
            // 'make' => ['Make'],
            // 'model' => ['Model'],
            // 'trim' => ['Trim'],
            // 'body' => ['Body', 'BodyStyle', 'Body_Style', 'BodyType', 'body_style'],
            // 'mileage' => ['Mileage', 'Miles', 'mileage.value'],
            // 'transmission' => ['Transmission', 'Tramsission', 'TransmissionType', 'TransmissionType'],
            // 'engine' => ['Engine', 'EngineDescription', 'Engine Description'],
            // 'engine_cylinders' => ['EngineCylinders', 'Engine Cylinders', 'Cylinders'],
            // 'engine_displacement' => ['EngineDisplacement', 'Displacement', 'EngineDisplacementCubicInches'],
            // 'fuel_type' => ['FuelType', 'Fuel_Type', 'Fuel_Type'],
            // 'drive_train' => ['DriveTrain', 'Drive_Type', 'drivetrain', 'Drivetrain'],
            // 'internet_price' => ['InternetPrice', 'Internet Price', 'Internet_Price'],
            // 'invoice' => ['Invoice'],
            // 'certified' => ['Certified', 'IsCpo', 'CertifiedCar'],
            // 'doors' => ['Doors'],
            // 'exterior_color' => ['ExtColor', 'ExteriorColor', 'OEMColorNameExterior', 'OEMColorNameInterior'],
            // 'interior_color' => ['IntColor', 'InteriorColor', 'OEMColorNameInterior'],
            // 'photo_urls' => ['PhotoUrls', 'Photo_URLs', 'Images', 'ImageURLs'],
            // 'date_in_stock' => ['DateInStock', 'DATE_IN_STOCK'],
            // 'date_added' => ['DateAdded', 'Date_Created', 'DateCreated'],
            // 'date_modified' => ['DateModified', 'DateUpdated', 'LastUpdated'],
            // 'price' => ['Price', 'SellingPrice', 'PrimaryPriceOrMSRP'],
            // 'sale_price' => ['SalePrice', 'Low_Price', 'sale_price'],
            // 'msrp' => ['MSRP'],
            // 'lease_payment' => ['LeasePayment'],
            // 'internet_special' => ['InternetSpecial', 'Internet_Special'],
            // 'book_value' => ['BookValue'],
            // 'description' => ['Description', 'Comments', 'VehicleComments'],
            // 'options' => ['Options'],
            // 'video_url' => ['VideoURL', 'VideoPlayerUrl', 'VideoEmbedUrl'],
            // 'fuel_economy_city' => ['FuelEconomyCity', 'MPGCity', 'CityMPG', 'MPG_City'],
            // 'fuel_economy_highway' => ['FuelEconomyHighway', 'MPGHighway', 'HighwayMPG', 'MPG_Highway'],
            // 'vehicle_status' => ['Status', 'Vehicle Status', 'StatusCode'],
            // 'dealer_name' => ['Dealer Name', 'Company_Name'],
            // 'dealer_address' => ['Dealer Address', 'Company_Address', 'address.addr1'],
            // 'dealer_city' => ['Dealer City', 'Company_City', 'address.city'],
            // 'dealer_state' => ['Dealer State', 'Company_State', 'address.region'],
            // 'dealer_zip' => ['Dealer Zip', 'Company_Zip', 'address.postal_code'],
            // 'stock_type' => ['New_Used', 'NEW-USED', 'NEW_USED', 'NEW_USED'],
            // 'vehicle_condition' => ['VehicleCondition', 'condition'],
            // 'carfax_one_owner' => ['CarfaxOneOwner', 'Carfax One Owner'],
            // 'carfax_available' => ['CarfaxAvailable', 'Carfax'],
            // 'certification_warranty' => ['CertificationWarranty', 'Certification Warranty'],
            // 'warranty_month' => ['WarrantyMonth'],
            // 'warranty_miles' => ['WarrantyMiles'],
            // 'listing_url' => ['Listing_URL', 'Link', 'VehicleDetailsPage'],
